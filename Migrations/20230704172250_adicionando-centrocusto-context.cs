...
{
    /// <inheritdoc />
    public partial class adicionandocentrocustocontext : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UsuCadastro = table.Column<int>(type: "int", nullable: false),
                    UsuAlteracao = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
